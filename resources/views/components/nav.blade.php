<nav class ="hidden lg:flex h-10v bg-nav flex flex-row justify-center items-center px-5 space-x-5">
...
<nav class ="flex lg:hidden bg-nav flex flex-col justify-start items-center px-5 space-y-5">
    ...
    <a href="" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> Contacta</a>
